...
const Header = () => {
    let Active = {
        backgroundColor : "rgba(139, 98, 2, 0.753)",
        color : "white"
    }
  return (
    <>
    <article className='sh'>
        ...
        <section className='grid grid-cols-4 h-14 gap-1'>
            <NavLink to="" style={({isActive})=> isActive ? Active : null}  className='text-[9px] md:text-[16px] w-full h-full font-bold flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 bg-white text-yellow-800 duration-500 transition-all hover:text-white hover:bg-yellow-800 border border-yellow-800 rounded-md cursor-pointer'>
                <p>Add_Product</p>
                <GrAnnounce size={20}/>
            </NavLink>
